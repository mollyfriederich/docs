...
If you wish to send a Single Send from a specific IP address, you can do so by creating an [IP Pool]({{root_url}}/ui/account-and-settings/ip-pools/). Once your IP Pool is created, you can select it as you draft your Single Send by navigating to Settings, clicking the IP Pool drop-down, and selecting the IP pool you wish to use. 
